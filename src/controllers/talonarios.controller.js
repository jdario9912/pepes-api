...
const crearOrden = async (req, res) => {
  const {id_cliente, nro_orden, fecha_creacion, atendido_por, fecha_entrega, hora_entrega, muestra, tipo, cantidad, tamano, modelo_anterior, tiene_logo, ubicacion_logo, numero_desde, puntillado_emblocado, color_duplicado, triplicado, color_triplicado, observaciones, total, entrega, estado, abono} = req.body;
  ...
  const campos = [fecha_entrega, hora_entrega, muestra, cantidad, modelo_anterior, tiene_logo, numero_desde, puntillado_emblocado, triplicado, total, entrega];
